...
import Plugin.helpers.HSHFitterThread;
...
//        groupType.add(this.radioBRGB);
    ...
    public void start(StringBuffer xmlPath) {
        ...
        try {
            ...
            this.OUTPUT = hi.getProjectName() + "_" + this.WIDTH + ".rti";
                ...
                public void mouseDragged(MouseEvent e) {
                    ...
                    try {
                        ...
                        if(pointList.size() > 2){
                            ...
                            textOutputFileName.setText(PROJECT_NAME + "_cropped_" + cropWidth + ".rti");
                        }
            ...
            Event ev2 = new Event();
            try {
                XMLPluginParser parser = new XMLPluginParser("Plugins/PluginHSHfitter.xml");
                String fitterLoc = parser.getFitterPath();
                String cropPath = parser.getCropFolder();

                if (fitterLoc.equals("")) {
                    JOptionPane.showMessageDialog(null, "Unable to automatically locate the HSHfitter Path!");
                    ev.setLevel(Level.WARNING.toString());
                    ev.setText("Unable to automatically locate the HSHfitter Path!");
                    xml.registEvent(ev);
                    ...
                    ev.setText("HSHfitter Path found : " + this.textHSHfitterLocation.getText());
                    xml.registEvent(ev);
                }
                ...
                JOptionPane.showMessageDialog(null, "Error retrieving PluginHSHfitter properties!");
                ev.setLevel(Level.SEVERE.toString());
                ev.setText("Error retrieving PluginHSHfitter properties!");
                xml.registEvent(ev);
            }
        ...
        // Go for Basic, not advanced, mode. To avoid user issues.
        this.advOptionCheckbox.doClick();
    ...
    public void handleSelectionPanelImage()
    {
        ...
        if (this.cache != null)
        {
            System.out.println("HSHFitterPlugin: Cache exists! ID:"+cache.getID());
    ...
    private void initComponents() {
        ...
        OrderSlider = new javax.swing.JSlider();
        jLabel13 = new javax.swing.JLabel();
        jLabel14 = new javax.swing.JLabel();
        ColorCorrectionButton = new javax.swing.JButton();
        jLabel15 = new javax.swing.JLabel();
        advOptionCheckbox = new javax.swing.JCheckBox();
        ...
        jPanel2.add(textOutputFileName, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 280, -1));
        ...
        jPanel2.add(originalHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, -1, -1));

        originalWidth.setText("xx");
        jPanel2.add(originalWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, -1, -1));
        ...
        jPanel2.add(cbResize, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, -1, -1));

        labelNewHeight.setText("New Height : ");
        jPanel2.add(labelNewHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, -1, -1));

        labelNewWidth.setText("New Width : ");
        jPanel2.add(labelNewWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 90, -1, -1));
        ...
        jPanel2.add(textNewHeight, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 80, 20));
        ...
        jPanel2.add(textNewWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, 80, 20));

        jLabel9.setText("HSHFitter Location : ");
        ...
        labelPx2.setText("(px)");
        jPanel2.add(labelPx2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 110, -1, -1));

        labelPx1.setText("(px)");
        jPanel2.add(labelPx1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 90, -1, -1));

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Performance Options:");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 160, -1));
        ...
        jPanel2.add(comboSpheres, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 250, 180, -1));

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Select sphere : ");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 130, -1));

        CPUComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Performance", "Battery Saving", "Cluster" }));
        CPUComboBox.setToolTipText("Choose which processing profile is desirable.");
        CPUComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CPUComboBoxActionPerformed(evt);
            }
        });
        jPanel2.add(CPUComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, 190, -1));

        MemoryComboBox.setMaximumRowCount(2);
        MemoryComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "High Memory Use (faster)", "Low Memory Use (slower)" }));
        MemoryComboBox.setToolTipText("High Memory Use option is always better unless memory is scarce");
        MemoryComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MemoryComboBoxActionPerformed(evt);
            }
        });
        jPanel2.add(MemoryComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 460, 190, -1));

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Memory profile:");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 460, 150, -1));

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Processor profile:");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 160, -1));

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Advanced options:");
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 150, -1));

        CompressionCheckBox.setToolTipText("Compressing will result in producing a smaller file");
        CompressionCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CompressionCheckBoxActionPerformed(evt);
            }
        });
        jPanel2.add(CompressionCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, -1, -1));

        OrderSlider.setMajorTickSpacing(1);
        OrderSlider.setMaximum(3);
        OrderSlider.setMinimum(1);
        OrderSlider.setPaintLabels(true);
        OrderSlider.setSnapToTicks(true);
        OrderSlider.setValue(2);
        OrderSlider.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                OrderSliderPropertyChange(evt);
            }
        });
        jPanel2.add(OrderSlider, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 180, -1));

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel13.setText("Order:");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 60, -1));

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel14.setText("Color Correction:");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 150, -1));

        ColorCorrectionButton.setText("Pick File");
        ColorCorrectionButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ColorCorrectionButtonActionPerformed(evt);
            }
        });
        jPanel2.add(ColorCorrectionButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 380, 100, -1));

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel15.setText("Compress output:");
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 150, -1));

        advOptionCheckbox.setSelected(true);
        advOptionCheckbox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                advOptionCheckboxActionPerformed(evt);
            }
        });
        jPanel2.add(advOptionCheckbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 290, -1, -1));

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("HSHfitter Output Information"));
        jPanel3.setToolTipText("Fitter Output Information");
        jPanel3.setName("HSHFitter Output Information"); // NOI18N
    ...
    private void buttonExecuteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonExecuteActionPerformed
        ...
        HSHFitterThread th = new HSHFitterThread(this.xmlPath.toString(), this.FITTER_ABSOLUTE_PATH, "", 
        ...
        th.setColorCorrection(this.colorCorrection);
        th.setCompressOutput(this.compressOutput);
        th.setMemoryProfile(this.memoryProfile);
        th.setOrderSetting(this.orderSetting);
        th.setPerformanceProfile(this.performanceProfile);
        th.setAdvOpt(this.advOptionCheckbox.isSelected());
        ...
        if ((f.isFile() && f.canExecute())) {
            ...
            JOptionPane.showMessageDialog(null, "Verify your HSHfitter path!");
        }
    ...
    private void buttonFindHSHlocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFindHSHlocActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                xmlaux = new XMLPluginParser("Plugins/PluginHSHfitter.xml");
                xmlaux.setFitterPath(fitterChooser.getSelectedFile().getPath());
            } catch (Exception ex) {
                Logger.getLogger(PluginPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        ...
        e.setText("HSHfitter path changed to : " + this.textHSHfitterLocation.getText());
        try {
    ...
    private void textNewWidthKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textNewWidthKeyReleased
        ...
        if (this.checkEditImage.isSelected()) {
            this.OUTPUT = this.PROJECT_NAME + "_cropped_" + new_width + ".rti";
        } else {
            this.OUTPUT = this.PROJECT_NAME + "_" + new_width + ".rti";
        }
        this.textOutputFileName.setText(this.OUTPUT);
    ...
    private void comboCropItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboCropItemStateChanged
        ...
        textOutputFileName.setText(PROJECT_NAME + "_" + WIDTH + ".rti");
        ...
        if (checkEditImage.isSelected()) {
            ...
            if (cropWidth != 0) {
                ...
                if (cbResize.isSelected()) {
                    ...
                    //this.textOutputFileName.setText(this.PROJECT_NAME + "_cropped_" + this.textNewWidth.getText() + ".rti");
                    this.cbResize.setSelected(false);
                    this.textNewHeight.setText("");
                    this.textNewWidth.setText("");
                    ...
                    this.textOutputFileName.setText(this.PROJECT_NAME + "_cropped_" + this.cropWidth + ".rti");
            ...
            if (cbResize.isSelected()) {
                this.textOutputFileName.setText(this.PROJECT_NAME + "_" + this.textNewWidth.getText() + ".rti");
                this.textNewHeight.setText("");
                this.textNewWidth.setText("");
            }
            this.textOutputFileName.setText(this.PROJECT_NAME + "_" + this.WIDTH + ".rti");
        }
    ...
    private void MemoryComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MemoryComboBoxActionPerformed
        // TODO add your handling code here:
        this.memoryProfile = this.MemoryComboBox.getSelectedIndex();
    ...
    private void CPUComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CPUComboBoxActionPerformed
        // TODO add your handling code here:
        this.performanceProfile = this.CPUComboBox.getSelectedIndex();
    }//GEN-LAST:event_CPUComboBoxActionPerformed

    private void OrderSliderPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_OrderSliderPropertyChange
        // TODO add your handling code here:
        this.orderSetting = this.OrderSlider.getValue();
    }//GEN-LAST:event_OrderSliderPropertyChange
    ...
    private void CompressionCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CompressionCheckBoxActionPerformed
        // TODO add your handling code here:
        this.compressOutput = this.CompressionCheckBox.isSelected();
    }//GEN-LAST:event_CompressionCheckBoxActionPerformed

    private void ColorCorrectionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ColorCorrectionButtonActionPerformed
        // TODO add your handling code here:

        // Get the path to the color correction file!
        //File chooser for selecting the image folder.
        JFileChooser jfc = new JFileChooser("Select Color Correction file");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            if (!jfc.getSelectedFile().isFile()) {
                ...
                this.colorCorrection = jfc.getSelectedFile().getAbsolutePath();
                return;
            }
        }


    }//GEN-LAST:event_ColorCorrectionButtonActionPerformed

    private void advOptionCheckboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_advOptionCheckboxActionPerformed
        // TODO add your handling code here:
        this.doAdvOptCBClick();
    }//GEN-LAST:event_advOptionCheckboxActionPerformed

    private void doAdvOptCBClick()
    {
        if (!this.advOptionCheckbox.isSelected())
        {
            // Disable buttons
            this.ColorCorrectionButton.setEnabled(false);
            //this.OrderSlider.setEnabled(false);
            this.CPUComboBox.setEnabled(false);
            this.CompressionCheckBox.setEnabled(false);
            this.MemoryComboBox.setEnabled(false);
        }
        else
        {
            // Enable buttons
            this.ColorCorrectionButton.setEnabled(true);
            //this.OrderSlider.setEnabled(true);
            this.CPUComboBox.setEnabled(true);
            this.CompressionCheckBox.setEnabled(true);
            this.MemoryComboBox.setEnabled(true);
        }
    }
    ...
    private javax.swing.JComboBox CPUComboBox;
    private javax.swing.JButton ColorCorrectionButton;
    private javax.swing.JCheckBox CompressionCheckBox;
    private javax.swing.JComboBox MemoryComboBox;
    private javax.swing.JSlider OrderSlider;
    private javax.swing.JCheckBox advOptionCheckbox;
