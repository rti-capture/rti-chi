 ...
 * @author matheus
 */
public class PTMFitterThread implements Runnable{
    ...
    public PTMFitterThread(String xmlpath){
        ...
        try{
           ...
           /* this.finishedFilesDir = "finishedfiles";
            ...
            e.printStackTrace();
            this.OUTPUT_FILE_NAME = this.ERROR_PROJECT_NAME + ".ptm";
        }

    }

    public PTMFitterThread(String xmlpath,String fitterPath,String lp,short type,String output,UUID sphereID){
        this.COMMAND_LINE_ARGUMENTS = new StringBuffer();
        this.FITTER_ABSOLUTE_PATH = new StringBuffer();
        ...
        try{
            ...
            e.setText("PTMfitter auxiliar started");
    ...
    private boolean writeLP(UUID sphereID){
        ...
        try{
            ...
            if(innerList.size() == 0){
                ...
                e.setText("Lp file with 0 images used!PTM will not be generated!");
                JOptionPane.showMessageDialog(null, "Lp file with 0 images used!PTM will not be generated!");
                xml.registEvent(e);
            return false;
            ...
            if(this.toResize){
                ...
                try {
                    ...
                    if(filePath.trim().contains(" ")){
                     ...
                     //Logger.getLogger(PTMFitterThread.class.getName()).log(Level.SEVERE, null, ex);
                    ex.printStackTrace();
                }
    ...
    private boolean generateCommandLineArgs() throws PathUndefined{
        ...
        if ((fitter.isFile()) && (fitter.canExecute())) {
            ...
            throw new PathUndefined("File not found or you dont have permissions to execute it");
        }
        ...
        if(!outputDir.exists()){
         ...
         this.argsList[4] = "-o";
         this.argsList[5] = outputDir.getAbsolutePath() + File.separator + this.OUTPUT_FILE_NAME;
    ...
    public void setOutputName(String name){
        ...
        if(!this.OUTPUT_FILE_NAME.contains(".ptm")){
            this.OUTPUT_FILE_NAME += ".ptm";
        }
    }
    ...
    public void run(){
        ...
        try {
            if(!res){
                JOptionPane.showMessageDialog(null, "Cannot Continue!Error while writing the String to execute the PTMFitter");
                return ;
            }
            ...
            try{
                ...
                ev.setText("Saved PTMfitter Path : " + this.FITTER_ABSOLUTE_PATH);
                xml.registEvent(ev);
            ...
            if((exitValue == return_value)&&(!erro)){
                ...
                Event ev = new Event();
                ev.setLevel(Level.WARNING.toString());
                ev.setText("Fitter return ok!PTM was generated successfully");
                xml.registEvent(ev);
            }else{
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error while trying to execute PTMFitter\nError dump : " + ex.getMessage());
            this.buttonExecute.setEnabled(true);
            ex.printStackTrace();
