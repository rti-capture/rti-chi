...
public class SubImageSaveHelper {
    ...
    public static boolean SaveImage(BufferedImage image,String filename, String WorkingDirectory, Boolean SAVEIMG) {
        if(!SAVEIMG) return false;
        String wd = WorkingDirectory + File.separator + filename;
        ...
        if (dir.isDirectory() && dir.canWrite()) {
            JAI.create("filestore", image , wd, "JPEG");
        }
        return true;
    }
