...
import RTIbuilder.helpers.exceptions.FileManipulationFileExtensionInvalid;
...
public class FileManipulation {
    ...
    public static boolean validExtension(java.io.File f, String CONF_IMAGE_ALLOWED_TYPE) throws FileManipulationFileExtensionInvalid {
        ...
        if (extension.trim().length() != 0 && CONF_IMAGE_ALLOWED_TYPE.toUpperCase().contains(extension.toUpperCase())) {
            return true;
        } 
		else {
			return false;
